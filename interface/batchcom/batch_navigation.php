...
&nbsp;<a class=menu target=Main href="../batchcom/batchcom.php"
 ...
 title="Batch Communication and Export"><?php xl('BatchCom','e');?></a>&nbsp;
</td>
<?php } ?>
...
&nbsp;<a class=menu target=Main href="../batchcom/smsnotification.php"
 onclick="top.restoreSession()"
 title="SMS Notification"><?php xl('SMS Notification','e');?></a>&nbsp;
</td>
<td valign="middle" nowrap>
&nbsp;<a class=menu target=Main href="../batchcom/emailnotification.php"
 onclick="top.restoreSession()"
 title="SMS Notification"><?php xl('Email Notification','e');?></a>&nbsp;
</td>
<td valign="middle" nowrap>
&nbsp;<a class=menu target=Main href="../batchcom/settingsnotification.php"
 onclick="top.restoreSession()"
 title="SMS/Email Alert Settings"><?php xl('SMS/Email Alert Settings','e');?></a>&nbsp;
</td>
<?php } ?>
